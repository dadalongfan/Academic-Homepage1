...
const messages = {
  zh: {
    ...
    'publications.researchDirections': '研究方向',
    'publications.projects': '代表项目',
    ...
    'home.featuredPapers': '代表论文',
    'home.more': '更多',
    'home.teamStyle': '团队风采',
    'home.dailyLife': '研途趣事',
    'home.annualEvents': '年度大事件',
    'home.researchDirection': '研究方向',
    'home.researchDirectionDesc': '课题组长期开展先进化工技术研究，主要方向包括：催化反应工程、煤间接液化、绿色化工过程、化工过程强化等。',
    'home.teamIntro': '课题组简介',
    'home.teamIntroDesc': '课题组致力于化工领域的前沿研究，拥有完善的实验设施和优秀的科研团队。',
    'home.leaderIntro': '负责人简介',
    'home.leaderIntroDesc': '课题组负责人，长期从事化工领域的教学与科研工作，在催化反应工程等方面取得重要成果。',
    'home.recruitment': '招贤纳士',
    'home.recruitmentDesc': '欢迎有志于化工研究的优秀学子加入课题组！我们提供良好的科研环境和广阔的发展平台。',
    'home.viewAll': '查看全部'
  },
  en: {
    'home': 'Homepage',
    ...
    'publications.researchDirections': 'Research Directions',
    'publications.projects': 'Representative Projects',
    ...
    'home.featuredPapers': 'Featured Papers',
    'home.more': 'More',
    'home.teamStyle': 'Team Style',
    'home.dailyLife': 'Daily Life',
    'home.annualEvents': ' Annual Events',
    'home.researchDirection': 'Research Directions',
    'home.researchDirectionDesc': 'Our team conducts cutting-edge research in chemical engineering, focusing on catalytic reaction engineering, coal-to-liquids, green chemical processes, and process intensification.',
    'home.teamIntro': 'Team Introduction',
    'home.teamIntroDesc': 'Our team is dedicated to frontier research in chemical engineering, with excellent experimental facilities and outstanding research personnel.',
    'home.leaderIntro': 'Principal Investigator',
    'home.leaderIntroDesc': 'The team leader has long been engaged in teaching and research in chemical engineering, achieving significant results in catalytic reaction engineering.',
    'home.recruitment': 'Join Us',
    'home.recruitmentDesc': 'We welcome outstanding students interested in chemical engineering research to join our team! We provide excellent research environment and broad development platform.',
